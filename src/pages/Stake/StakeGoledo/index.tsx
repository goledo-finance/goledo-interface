...
const StakeGoledo: React.FC = () => {
  ...
  return (
    <Card title="Stake Goledo" titleRight={APR} titleIcon="i-uil:shield-plus">
      ...
      <Button id='stake-stake-goledo-stake-btn' fullWidth size="large" loading={!balance} disabled={true || balance?.equalsWith(Zero)} onClick={() => showStakeGolModal({ type: 'Stake' })}>
        Stake
      </Button>
    </Card>
  );
