...
const columns: Columns<TokenInfo> = [{
  ...
  render: () => (
    <div className='w-full h-full flex justify-end items-center gap-12px'>
      <Button size='small' className='max-w-76px w-50% !flex-shrink-1 lt-md:max-w-none'>Repay</Button>
      <Button size='small' variant='outlined' className='max-w-76px w-50% !flex-shrink-1 lt-md:max-w-none'>Borrow</Button>
    </div>
  )
}];
