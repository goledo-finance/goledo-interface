...
export const createCFXData = ({ amount, account }: { amount: string; account: string; }) => WETHGatewayContract.interface.encodeFunctionData('repayCFX', [import.meta.env.VITE_LendingPoolAddress, amount, 2, account])
