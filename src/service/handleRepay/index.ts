...
export const createCFXData = (account: string) => WETHGatewayContract.interface.encodeFunctionData('repayETH', [import.meta.env.VITE_LendingPoolAddress, walletStore.getState().balance?.toHexMinUnit(), 2, account])
